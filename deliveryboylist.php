...
<body>
    ...
    <div id="welcome" style="height: 50px;">
        <h2 style="font-size: 30px;text-align: left"><u>Delivery Boys</u></h2>
  ...
  <div style="height: 500px" align="center">
      ...
      <table border="1" cellspacing="none" style="text-align: center">
          <tr>
            ...
            <th style="font-size:20px">Vahicle No</th>
            <th style="font-size:20px">Doc Image</th>
            <th style="font-size:20px">Option</th>
            
          </tr>
      <?php
      require_once './connection.php';
      $query=" select * from users where role='DeliveryBoy'";
      ...
      if ($n>0)
      {
          ...
          <tr>
                ...
                <td style="font-size: 15px;font-weight: bold"><?php echo $d[4].",".$d[5].",".$d[6] ; ?></td>
                <td style="font-size: 15px;font-weight: bold"><?php echo $d[8] ; ?></td>
                <td style="font-size: 15px;font-weight: bold"><img src="<?php echo $d[9] ; ?>" height="30px" width="50px"></td>
